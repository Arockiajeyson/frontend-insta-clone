    ...
    return (
        <div className='main-container'>
            <div className="hearder">
                <img className="logo" src="./assets/clone_img.png" /><img className='instaclone-img' src=" https://www.instaclone.app/img/instaclone-logo-dark.png"  />
                <Link to={"/posting"}><img className="insta-icon" src="./assets/camera_icon.png" /></Link>
            </div>
